...
public class AdminDao {
    ...
    public void addAdmin(String name, String contact, String email, String password, String address, String gender, String DOB){
        String query = "INSERT INTO admins (admin_name, email, address, contact, current_password, gender, D_O_B) VALUES (?,?,?,?,?,?,?)";
