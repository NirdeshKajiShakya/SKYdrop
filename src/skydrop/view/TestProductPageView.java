 ...
 * @author Suresh
 */
public class TestProductPageView extends javax.swing.JFrame {

    /**
     * Creates new form ProductPageView
     */
    public TestProductPageView() {
        initComponents();
    }
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestProductPageView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TestProductPageView().setVisible(true);
            }
        });
    }
